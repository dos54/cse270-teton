...
class TestSmoke():
  ...
  def test_smoke(self):
    ...
    self.driver.set_window_size(1353, 1052)
    ...
    self.driver.find_element(By.NAME, "bizname").send_keys("Steven\'s Business")
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "email").send_keys("email@email.com")
    self.driver.find_element(By.NAME, "cellphone").click()
    self.driver.find_element(By.NAME, "cellphone").send_keys("123-456-7890")
    self.driver.find_element(By.NAME, "submit").click()
    self.driver.find_element(By.LINK_TEXT, "Admin").click()
    elements = self.driver.find_elements(By.ID, "username")
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").click()
    self.driver.find_element(By.ID, "username").send_keys("nottheusername")
